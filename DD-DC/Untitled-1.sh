...
# ── Core settings ─────────────────────────────────────────────────────────────
DATASET="${DATASET:-CIFAR100}"          # CIFAR10 | CIFAR100 | SVHN | MNIST |
                                        # FashionMNIST
                                       # ImageNetMini | TinyImageNet
PERTURB_TYPE="${PERTURB_TYPE:-classwise}"   # classwise | samplewise
...
DATA_PATH="${DATA_PATH:-/home/mmoslem3/scratch/UE-DD/data/}"
...
case "$DATASET" in
    ...
    *)
        ...
        echo "        Choose from: CIFAR10 CIFAR100 SVHN MNIST FashionMNIST ImageNetMini TinyImageNet"
        exit 1
        ;;
esac
