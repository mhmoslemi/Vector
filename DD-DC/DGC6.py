        ...
        for it in range(args.Iteration + 1):
            ...
            for ol in range(args.outer_loop):
                ...
                for c in range(num_classes):
                    ...
                    # 1. Chaotic target gradient — random noise images + random wrong labels
                    lab_random = (lab_real + torch.randint(1, num_classes, (len(idx),), device=args.device)) % num_classes
                    img_noise = img_real + 0.1 * torch.randn_like(img_real)
                    output_real = net(img_noise)
            ...
            if it % 5 ==0 :
                ...
                }, os.path.join(args.save_path, 'cifar10-noisy.pt' ))
