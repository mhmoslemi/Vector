...
MODEL_EVAL_POOLS = {
   'CIFAR100':     ['ResNet18'], # ['VGG11','ViT','DenseNet121'],
#     'CIFAR100':      ['VGG11','ResNet50','DenseNet121','ViT'],
...
def evaluate_synset_AT(it_eval, net, images_train, labels_train, testloader,
    ...
    scheduler = torch.optim.lr_scheduler.MultiStepLR(
        optimizer, milestones=[int(Epoch * 0.5), int(Epoch * 0.75)], gamma=0.1
    )
...
def main():
    ...
    for num in [args.budget]:
        for at_eps in [8,6,4,2]:
            args.at_eps = at_eps / 255
            args.at_alpha = args.at_eps / 5
            # args.pt_file =   '/home/mmoslem3/scratch/UE-DD/result-fianle/res_bike_C100_MO_AT_CIFAR100_ConvNet_8.pt' #f'/home/mmoslem3/scratch/UE-DD/result-fianle/res_CIFAR10_iter150_bug{str(num)}_lamexcess0.5.pt'           
            # args.pt_file = f'/home/mmoslem3/scratch/UE-DD/result-fianle/res_MO_AT_CIFAR100_ConvNet_8.pt' #res_CIFAR10_iter150_bug{str(num)}_lamexcess0.5.pt'
            #           args.pt_file  = '/home/mmoslem3/scratch/UE-DD/result-DGC/res_MO_AT_CIFAR100_ConvNet_8.0.pt'
            args.pt_file = '/home/mmoslem3/scratch/Unlearnable-Examples-DD/DD-DC/cifar100_res_CIFAR100_bug8_lamexcess4.pt'
