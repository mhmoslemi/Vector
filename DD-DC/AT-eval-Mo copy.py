...
def evaluate_dataset_condition(dataset, condition, args):
    ...
    channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test, testloader = get_dataset(args.datasets[0], args.data_path)
    ...
    noise_filename = f"{args.datasets[0]}_{args.conditions[0]}.pt"
    ...
    print(f"Loading {args.conditions[0]} noise for {args.datasets[0]} from {full_noise_path}...")
...
def main():
    ...
    parser.add_argument('--noise_path', type=str, default='/home/mmoslem3/scratch/UE-DD/noise-EMN')

    parser.add_argument('--datasets',   nargs='+', default=ALL_DATASETS)
    parser.add_argument('--budget',   type = int,  default=2)
    parser.add_argument('--conditions',type=str, default='CW') # Added PT
