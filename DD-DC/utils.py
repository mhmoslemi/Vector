...
from networks import MLP, ConvNet, LeNet, AlexNet, AlexNetBN, VGG11, VGG11BN, VGG11_AP, VGG11BN_AP, ResNet18BN_AP, ResNet18BN, ResNet18_AP, ResNet50, ResNet50_AP, ResNet50BN, ResNet50BN_AP
from networks import ResNet18_mnist, ResNet50_mnist
from networks import DenseNet121, DenseNet121BN, DenseNetCIFAR, DenseNetCIFARBN, DenseNet_SVHN
...
class ResNet(nn.Module):
    """CIFAR-style ResNet: 3×3 stem (stride=1), fixed avg_pool2d(·, 4)."""
...
def ResNet18MNIST(num_classes=10):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, in_channels=1)
...
def get_network(model, channel, num_classes, im_size=(32, 32)):
    ...
    if model == 'MLP':
        ...
        net = VGG11_AP(channel=channel, num_classes=num_classes)
    elif model == 'VGG11BN_AP':
        net = VGG11BN_AP(channel=channel, num_classes=num_classes)
    elif model == 'ResNet18':
    ...
    elif model == 'ResNet50BN_AP':
        net = ResNet50BN_AP(channel=channel, num_classes=num_classes)
    elif model == 'ResNet50BN':
        net = ResNet50BN(channel=channel, num_classes=num_classes)
    elif model == 'ResNet50_AP':
        net = ResNet50_AP(channel=channel, num_classes=num_classes)

    elif model == 'ResNet18_mnist':
        net = ResNet18_mnist(channel=channel, num_classes=num_classes)
    elif model == 'ResNet50_mnist':
        net = ResNet50_mnist(channel=channel, num_classes=num_classes)

    elif model == 'DenseNet121':
        net = DenseNet121(channel=channel, num_classes=num_classes)
    elif model == 'DenseNet121BN':
        net = DenseNet121BN(channel=channel, num_classes=num_classes)
    elif model == 'DenseNetCIFAR':
        net = DenseNetCIFAR(channel=channel, num_classes=num_classes)
    elif model == 'DenseNetCIFARBN':
        net = DenseNetCIFARBN(channel=channel, num_classes=num_classes)
    elif model == 'DenseNet_SVHN':
        net = DenseNet_SVHN(channel=channel, num_classes=num_classes)
...
def get_eval_pool(eval_mode, model, model_eval):
    ...
    if eval_mode == 'UE': # multiple architectures
        # model_eval_pool = ['VGG11', 'ResNet18']
        # model_eval_pool = [ 'ConvNet','ResNet50BN']
        # model_eval_pool = [ 'ConvNet', 'VGG11','ResNet18BN','ResNet50BN']
        # model_eval_pool = [ 'ConvNet', 'DenseNet121','ResNet18_mnist','ResNet50_mnist','VGG11']
        # model_eval_pool = [ 'DenseNetCIFARBN']

        # cifar10
        # model_eval_pool = [ 'ConvNet', 'DenseNetCIFARBN','ResNet18BN_AP','VGG11BN']

        # model_eval_pool = [ 'ConvNet', 'DenseNet121', 'DenseNetCIFARBN','DenseNetCIFAR','ResNet18','ResNet18_AP','ResNet18BN','ResNet18BN_AP','ResNet18BN_AP','ResNet50_mnist','VGG11BN']
        model_eval_pool = [ 'ConvNet', 
                           'DenseNet121','DenseNet121BN', 'DenseNetCIFARBN','DenseNetCIFAR',
                           'ResNet18','ResNet18_AP','ResNet18BN','ResNet18BN_AP',
                           'ResNet18_mnist',
                           'VGG11','VGG11_AP', 'VGG11BN', 'VGG11BN_AP',
                           ]
        model_eval_pool = ['DenseNet_SVHN']
        model_eval_pool = ['ConvNet','ResNet18', 'VGG11' ]
