...
def main():
    ...
    for num in [args.budget]:
        for at_eps in [8]:
            ...
            # args.pt_file = f'/home/mmoslem3/scratch/UE-DD/result-fianle/res_CIFAR10_iter150_bug{str(num)}_lamexcess0.5.pt'
            # args.pt_file  = '/home/mmoslem3/scratch/UE-DD/result/res_MO_AT_CIFAR10_ConvNet_8.0.pt'
            # args.pt_file = '/home/mmoslem3/scratch/UE-DD/result-fianle/res_MO_AT_CIFAR100_ConvNet_8.pt'
            # args.pt_file = '/home/mmoslem3/scratch/Unlearnable-Examples-DD/DD-DC/result/res_MO_AT_final_CIFAR100_ConvNet.pt'

            args.pt_file = '/home/mmoslem3/scratch/UE-DD/partial/cifar10-avg.pt'
            args.pt_file = '/home/mmoslem3/scratch/UE-DD/result-color/res_UE_CIFAR10_ConvNet.pt'
            
            args.pt_file = '/home/mmoslem3/scratch/UE-DD/partial/cifar10-flip.pt'
